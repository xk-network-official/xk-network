...
XK Network is currently a founder-led, early-stage independent project. The public project lead is **Yukun Zang**, responsible for project direction, documentation, and coordination.

The project does not currently represent that it has employees, advisers, institutional partners, or an incorporated entity. Its official X, Telegram, GitHub, website, and email are project-controlled sources; they do not independently verify professional identity.

## Token facts

- Contract: `0x603a874c9b7810bcd1ff7ce06cea0f2af3c8d1be`
- Creator address: `0x4b48cc2cee7eb582fe473080141147a5d72c82ee`
- Name and symbol: XK Token (XKT)
- Network: BNB Smart Chain
- Supply and decimals: 100,000,000 XKT; 18 decimals
- Published contract behavior: fixed constructor mint, no additional mint function, and no transfer-tax logic
