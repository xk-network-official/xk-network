# XK Network Public Roadmap

Roadmap items are public work items, not promises of delivery dates, token value, listings, or financial outcomes.
...
Dates will be published only after scope, resources, and an accountable owner are defined.
